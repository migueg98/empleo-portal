...
const mockApplications: JobApplication[] = [
  {
    ...
    relevantExperience: 'Desarrolladora Frontend con 6 años de experiencia en React, TypeScript y metodologías ágiles. He liderado equipos de 4 personas.',
    availability: 'Inmediata',
    additionalComments: 'Me interesa especialmente trabajar en proyectos innovadores.',
    status: 'received',
  ...
  },
  {
    ...
    relevantExperience: 'Especialista en marketing digital con 4 años gestionando campañas en Google Ads y redes sociales. Certificado en Analytics.',
    availability: 'A partir del 1 de marzo',
    additionalComments: '',
    status: 'reviewing',
  ...
  },
  {
    ...
    relevantExperience: 'Analista de datos con experiencia en Python, SQL y Power BI. He trabajado en proyectos de análisis predictivo y business intelligence.',
  ...
  },
  {
    ...
    relevantExperience: 'Frontend Developer con experiencia en Vue.js y React. Participé en el desarrollo de aplicaciones web para el sector fintech.',
    availability: 'Inmediata',
